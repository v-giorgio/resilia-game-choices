...
const checkAnswer2 = (answer) => {
  ...
  if (answer == 1) image.src = "./assets/pets-icon.png";
  else if (answer == 2) image.src = "./assets/cat-icon.png";
  else if (answer == 3) image.src = "./assets/bird-icon.png";
  else {
    alert("Opção inválida. Vamos usar o cachorrinho mesmo");
    image.src = "./assets/pets-icon.png";
  }
...
const checkAnswer3 = (answer) => {
  ...
  if (answer == 1) logoName.textContent = "Pets&Cia";
  else if (answer == 2) logoName.textContent = "AdoteAqui";
  else if (answer == 3) logoName.textContent = "Petzinhos";
  else {
    alert("Opção inválida. Vamos usar o nosso nome favorito");
    logoName.textContent = "Pets&Cia";
  }
};
...
let answer4 = parseInt(
  prompt(
    "Mas ainda não falamos um pouquinho sobre o aplicativo. Qual será o melhor título para descrição?\n\n(1) Adote já seu pet!\n(2) Nossos animaizinhos querem um lar!\n(3) Doação de animais!"
  )
);
const checkAnswer4 = (answer) => {
  let title = document.querySelector(".title");
  if (answer == 1) title.textContent = "Adote já seu pet!";
  else if (answer == 2)
    title.textContent = "Nossos animaizinhos querem um lar!";
  else if (answer == 3) title.textContent = "Doação de animais!";
  else {
...
let answer5 = parseInt(
  prompt(
    "E quanto à descrição?\n\n(1) Entre em contato com a nossa organização e adote seu pet.\n(2) Faça sua doação pelo aplicativo e salve a vida de um animalzinho.\n(3) Venha para o nosso grande evento e leve para casa um novo melhor amigo."
  )
);
const checkAnswer5 = (answer) => {
  ...
  if (answer == 1)
    description.textContent =
      "Entre em contato com a nossa organização e adote seu pet.";
  else if (answer == 2)
    description.textContent =
      "Faça sua doação pelo aplicativo e salve a vida de um animalzinho.";
  else if (answer == 3)
    description.textContent =
      "Venha para o nosso grande evento e leve para casa um novo melhor amigo.";
  else {
...
const checkAnswer6 = (answer) => {
  ...
  footerName.textContent = logoName.textContent;
  if (answer == 1) {
    let link = document.createElement("a");
    link.textContent = "Baixe já o aplicativo";
    link.href = "./PetsApp.js";
    footerOption.appendChild(link);
  } else if (answer == 2) {
    let image = document.createElement("img");
    if (temp == 1) image.src = "./assets/pets-icon.png";
    else if (temp == 2) image.src = "./assets/cat-icon.png";
    else if (temp == 3) image.src = "./assets/bird-icon.png";
    image.classList.add("img-size");
...
const checkAnswer9 = (answer) => {
  ...
  if (answer == 1) {
    ...
    title.classList.add("font-color-pink");
    description.classList.add("font-color-pink");
  } else if (answer == 3) {
